...
//    GOLD(MiningLevels.WOOD, 32, 24.0f, 0.0f, 22, () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    MATERIAL(MiningLevels.IRON, 850, 24.0f, 3.0f, 22, () -> Ingredient.ofItems(ModItems.PEARL_SHARD));
